...
import com.fabian.rappi.rappi.adapters.RecyclerClickListener;
import com.fabian.rappi.rappi.adapters.RecyclerViewAdapter;
import com.fabian.rappi.rappi.conexion.AsyncTaskDownload;
import com.fabian.rappi.rappi.conexion.AsyncTaskJson;
import com.fabian.rappi.rappi.conexion.AsyncTaskRefreshRecycler;
import com.fabian.rappi.rappi.models.Respuesta;
import com.fabian.rappi.rappi.utils.Constants;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv.addOnItemTouchListener( // and the click is handled
                new RecyclerClickListener(this, new RecyclerClickListener.OnItemClickListener() {
                    @Override public void onItemClick(View view, int position) {
                        ...
                        myIntent.setClass(MainActivity.this, DetailTema.class);
                        Bundle myBundle = new Bundle();
                        myBundle.putSerializable("data", temas.getChildren().get(position).getData());
        ...
        if (globalClass.TestConection())
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("En este momento no cuentas con conexión a internet")
