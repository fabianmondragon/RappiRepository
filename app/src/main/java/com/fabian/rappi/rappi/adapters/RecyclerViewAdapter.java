package com.fabian.rappi.rappi.adapters;
...
import com.fabian.rappi.rappi.activities.DetailTema;
import com.fabian.rappi.rappi.activities.MainActivity;
import com.fabian.rappi.rappi.models.Child;
import com.fabian.rappi.rappi.models.Data;
    ...
    public class WhithoutBanner extends TemaViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (v.equals(share)) {
                ...
                sharingIntent.setType("text/plain");
                String shareBody = temas.get(possition).getData().getUrl() + "," + temas.get(possition).getData().getTitle();
                sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Reddit");
            ...
            if (v.equals(cv)) {
                ...
                /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    contex.startActivity(myIntent, ActivityOptions.makeSceneTransitionAnimation(MainActivity.this).toBundle());
                }
                else
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    contex.startActivity(myIntent, ActivityOptions.makeSceneTransitionAnimation().toBundle());
                }
                else
                contex.startActivity(myIntent);*/
